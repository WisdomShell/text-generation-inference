...
run-llama2:
	text-generation-launcher --model-id /shd/zzr/code_copilot/training/original_models/llama2-7b/ --port 3030 --max-total-tokens 5000 --max-input-length 4096 --num-shard 1
